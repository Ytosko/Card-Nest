...
if (!verifyOnly) {
  ...
  await managementRequest('PATCH', {
    ...
    webauthn_rp_display_name: 'Card Nest',
    webauthn_rp_id: 'cardnest.ytosko.dev',
    webauthn_rp_origins: 'https://cardnest.ytosko.dev,android:apk-key-hash:Bqtfmz54qLKCcrBOnjCD21m3noWsHinTAkQ-XDPk_pw',
    mailer_subjects_confirmation: 'Confirm your Card Nest account',
