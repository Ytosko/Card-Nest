// Lightweight zero-dependency MD5 hashing for Gravatar URLs
...
function md5cycle(x: number[], k: number[]) {
  ...
  d = ii(d, a, b, c, k[3], 10, -1894980668);
  ...
  a = ii(a, b, c, d, k[6], 6, -145523070);
  d = ii(d, a, b, c, k[13], 10, -1120210379);
  c = ii(c, d, a, b, k[4], 15, 718787259);
  b = ii(b, c, d, a, k[11], 21, -343485551);
